...
public interface Grid<E> extends Iterable<E>, Serializable {
    ...
    /**
     * Checks if this grid contains every element of the provided tuple {@code t}.
     *
     * @param t The tuple of which to check for containment
     * @return {@code true} if this grid contains every element of the tuple {@code t}
     */
    boolean containsAll(@Nonnull Tuple<?> t);

    /**
     * Checks if this grid contains every element of the provided collection {@code c}.
     *
     * @param c The collection of which to check for containment
     * @return {@code true} if this grid contains every element of the collection {@code c}
     */
     ...
     * @throws IndexOutOfBoundsException When the range is out of bounds
     */
    void setAll(int r1, int c1, int r2, int c2, @Nonnull Grid<? extends E> g)
     ...
     * @throws IndexOutOfBoundsException When the range is out of bounds
     */
    void setAll(@Nonnull Index i1, @Nonnull Index i2, @Nonnull Grid<? extends E> g)
            throws IndexOutOfBoundsException;
    ...
    /**
     * Applies the provided transformation function {@code f} to each element of this grid,
     * then returns a new grid containing the resulting elements.
     * This operation preserves the type bounds of this grid.
     *
    ...
    /**
     * Returns a one-dimensional primitive array containing every element of this grid.
