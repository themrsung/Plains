...
public interface DoubleGrid extends BaseGrid<Double> {
     ...
     */
    double get(int r, int c) throws IndexOutOfBoundsException;
     ...
     * @throws IndexOutOfBoundsException When the indices are out of bounds
     */
    void set(int r, int c, double v) throws IndexOutOfBoundsException;
     ...
     */
    void fillRange(int r1, int c1, int r2, int c2, double v) throws IndexOutOfBoundsException;
     ...
     * @param f The function of which to apply to each element of this grid
     */
    void update(@Nonnull TriFunction<? super Integer, ? super Integer, ? super Double, Double> f);
     ...
     */
    @Nonnull
    DoubleGrid subGrid(int r1, int c1, int r2, int c2) throws IndexOutOfBoundsException;
     ...
     * @throws IndexOutOfBoundsException When the range is out of bounds
     */
    void setRange(int r1, int c1, int r2, int c2, @Nonnull DoubleGrid g) throws IndexOutOfBoundsException;
     ...
     */
    @Nonnull
    DoubleGrid map(@Nonnull DoubleUnaryOperator f);
     ...
     */
    @Nonnull
    <F> Grid<F> mapToObj(@Nonnull DoubleFunction<? extends F> f);
