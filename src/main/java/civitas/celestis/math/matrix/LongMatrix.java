...
/**
 * A numerical grid structure of raw primitive {@code long}s.
 * <p>
 * This class is preferred over grids of boxed {@link Long} due to less
 * overhead in dealing with objects.
 * </p>
 * <p>
 * Since {@code long}s are an efficient container of 64 bits of data,
 * this matrix can be used to house any form of data which can be packed into 64 bits.
 * </p>
 */
public class LongMatrix implements RawLongMatrix<LongMatrix> {
    //
    // Constants
    //
     ...
     */
    @Serial
    private static final long serialVersionUID = 3270209729148135140L;
     ...
     */
    public LongMatrix(@Nonnull Index size) {
     ...
     */
    public LongMatrix(@Nonnull Grid<Long> g) {
        this.rows = g.rows();
    ...
    @Nonnull
    @Override
    public LongMatrix subtract(long s) {
        final LongMatrix result = new LongMatrix(rows, columns);
    ...
    @Nonnull
    @Override
    public LongMatrix multiply(long s) {
        final LongMatrix result = new LongMatrix(rows, columns);
    ...
    @Nonnull
    @Override
    public LongMatrix divide(long s) throws ArithmeticException {
    ...
    /**
     * As primitive {@code long}s cannot be {@code null},
     * this method does nothing.
     *
     * @param ignored Ignored
     */
    @Override
    public void fillEmpty(Long ignored) {}
    ...
    @Nonnull
    @Override
    public LongMatrix subGrid(int r1, int c1, int r2, int c2) throws IndexOutOfBoundsException {
    ...
    @Nonnull
    @Override
    public LongMatrix subGrid(@Nonnull Index i1, @Nonnull Index i2) throws IndexOutOfBoundsException {
        final int r1 = i1.row();
     ...
     */
    @Override
    public void setAll(int r1, int c1, int r2, int c2, @Nonnull Grid<? extends Long> g) throws IndexOutOfBoundsException {
        for (int r = r1; r < r2; r++) {
            for (int c = c1; c < c2; c++) {
     ...
     */
    @Override
    public void setAll(@Nonnull Index i1, @Nonnull Index i2, @Nonnull Grid<? extends Long> g) throws IndexOutOfBoundsException {
        final int r1 = i1.row();
        final int c1 = i1.column();
        final int r2 = i2.row();
        final int c2 = i2.column();
    ...
    @Nonnull
    @Override
    public <F> ArrayGrid<F> map(@Nonnull Function<? super Long, F> f) {
    ...
    @Nonnull
    @Override
    public LongMatrix resize(@Nonnull Index size) {
    ...
    public Collection<Long> collect() {
        final List<Long> unwrapped = new ArrayList<>();
    ...
    public Map<Index, Long> map() {
        final Map<Index, Long> result = new HashMap<>();
    ...
    public Iterator<Long> iterator() {
        final long[] unwrapped = new long[rows * columns];
     ...
     */
    @Nonnull
    public static LongMatrix parseMatrix(@Nonnull String s) throws NumberFormatException {
