...
public class Vector3 implements Vector<Vector3> {
     ...
     */
    @Serial
    private static final long serialVersionUID = -2781260903474247112L;
     ...
     * @throws IllegalArgumentException When the provide vector {@code v}
     *                                  does not have three components
     */
    ...
    public Vector3(@Nonnull Tuple<Double> t) {
        if (t.size() != 3) {
            throw new IllegalArgumentException("The provided tuple's size is not three.");
        }
    ...
    public double get(int i) throws IndexOutOfBoundsException {
        return switch (i) {
            ...
            case 1 -> y;
            case 2 -> z;
            default -> throw new IndexOutOfBoundsException("The index " + i + " is out of bounds for size 3.");
        };
    }
    ...
    @Nonnull
    @Override
    public Vector3 transform(@Nonnull UnaryOperator<Double> f) {
